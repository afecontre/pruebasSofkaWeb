...
public class AddItemFullApproval implements Task {


    public AddItemFullApproval() {
        //Nothing
    }

    public static AddItemFullApproval withTheFollowingField() {
        return instrumented(AddItemFullApproval.class);
    }
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        for (String loanNumber : loanNumbers) {
            ...
            actor.attemptsTo(
                    ...
                    Click.on(BTN_APPROVE_ALL_ITEM),
                    Click.on(BTN_EXCLUDE_ALL_RETAINAGE),
                    Click.on(BTN_MARK_ALL_DEPOSIT),
