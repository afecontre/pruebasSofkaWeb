...
public class AddItemContingencyApprove implements Task {


    public AddItemContingencyApprove() {
       //Nothing
    }

    public static AddItemContingencyApprove withTheFollowingField() {
        return instrumented(AddItemContingencyApprove.class);
    }
        ...
        for (String loanNumber : loanNumbers) {
            ...
            actor.attemptsTo(
                ...
                actor.should(
                        ...
                        seeThat(ObtainText.element(LBL_TOTAL_APPROVED),containsString(REQUESTING_CONTINGENCY)).orComplainWith(NotFoundText.class,NotFoundText.THE_VALUE_IS_NOT_EXPECT),
                        seeThat(ObtainText.element(LBL_TOTAL_RETAINAGE),containsString(RETAINAGE_CONTINGENCY)).orComplainWith(NotFoundText.class,NotFoundText.THE_VALUE_IS_NOT_EXPECT),
                        seeThat(ObtainText.element(LBL_TOTAL_APPROVED_LESS_RETAINAGE),containsString(OperationsMath.restarNumeros(REQUESTING_CONTINGENCY,contingency))).orComplainWith(NotFoundText.class,NotFoundText.THE_VALUE_IS_NOT_EXPECT)
                );
